...
func PromptSellStock() {
	scanner := bufio.NewScanner(os.Stdin)
	fmt.Println("Let's sell stock position from your portfolio!")
	fmt.Println("What is the stock ticker?")
	scanner.Scan()
	ticker := scanner.Text()
	fmt.Println("What is the amount of stocks sold?")
	scanner.Scan()
	...
	fmt.Println("What is the cost per share at the moment of selling?")
	scanner.Scan()
	...
	services.SellStock(ticker, amount, cost_per_share, transaction_date)
}
